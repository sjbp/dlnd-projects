...
This is my submition to Udacity's Deep Learning ND Project 2 on Image Recognition for CIFAR-10.

Note: The floyd adaptation of this project is based on ludwiktrammer's fork of the udacity repo. For the original can be found [here](https://github.com/ludwiktrammer/deep-learning). The rest of this README is copied from this source.
